...
class RoadmapEpigenomicsDataset(BioBigWigDataset):
    ...
    DNase = _build_celline_enum('DNase', DNase) 
    ...
    H3K27ac = _build_celline_enum('H3K27ac', H3K27ac)
    ...
    H3K27me3 = _build_celline_enum('H3K27me3', H3K27me3)
    ...
    H3K36me3 = _build_celline_enum('H3K36me3', H3K36me3)
    ...
    H3K4me1 = _build_celline_enum('H3K4me1', H3K4me1)
    ...
    H3K4me3 = _build_celline_enum('H3K4me3', H3K4me3)        
    ...
    H3K9ac = _build_celline_enum('H3K9ac', H3K9ac) 
    ...
    H3K9me3 = _build_celline_enum('H3K9me3', H3K9me3) 
